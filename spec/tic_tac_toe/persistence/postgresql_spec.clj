...
(describe "postgresql persistence"
  ...
  (it "Load game returns a saved state that matches the loaded state"
  ...
  (it "loads the last in-progress game when no game-id is provided - returns found-save status"
